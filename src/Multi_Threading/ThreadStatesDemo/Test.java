package Multi_Threading.ThreadStatesDemo;
...
public class Test implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        //thread1 created and its currently in the NEW state
    ...
    public void run() {
        ...
        //thread2 created and it currently in the NEW state
        System.out.println("State of thread2 after creating it - " + thread2.getState());

        thread2.start();

        //thread2 move to Runnable state
